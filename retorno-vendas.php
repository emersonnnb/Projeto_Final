...
$fim = $_POST['fim'];
if($produto != ''){
    $sql = mysql_query("SELECT * FROM vendas WHERE id_usuario='$usuario' AND codigobarra='$produto' AND data_venda BETWEEN '$inicio' AND '$fim' ORDER BY data_venda ASC") or die (mysql_error());
}else{
