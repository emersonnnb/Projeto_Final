        ...
        <form action="cliente_cadastrar.php" method="POST" enctype="multipart/form-data"  name="cadastro">
            <div class="row">
                <div class="form-group col-12 col-md-3">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" maxlength="10" placeholder="Insira seu nome" required>
                </div>
                <div class="form-group col-12 col-md-3">
                ...
                <div class="form-group col-12 col-md-2">
                    ...
                    <input type="text" class="form-control" id="rg" name="rg" placeholder="xxxxxxxx-x" required>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-12 col-md-3">
